          ...
          <>
            ...
            {isRental && (
              <div className="mt-5 space-y-3">
                <p className="font-[Space_Grotesk] text-sm tracking-[0.1em] text-[#8C846F]">
                ...
                {overLimit && (
                  <p className="rounded-sm bg-[#FBF1E4] px-3 py-2 font-[Space_Grotesk] text-sm leading-5 text-[#8A6B3A]">
