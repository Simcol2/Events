...
export default function FeatureCard({ icon: Icon, name, tagline, description, photoKey, photoUrl, priceLabel, selected, onClick }) {
  ...
  return (
    ...
    >
      <PhotoSlot photoKey={photoKey} photoUrl={photoUrl} label={name} />
