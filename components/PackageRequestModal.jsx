...
function LineRow({ label, price }) {
  return (
    <div className="flex items-center justify-between gap-3 py-1">
      <span className="font-[Space_Grotesk] text-sm text-[#5C5645]">{label}</span>
      {price > 0 ? (
        <span className="font-[Space_Grotesk] text-sm font-medium text-[#8C846F]">+${price.toLocaleString()}</span>
      ) : (
        <span className="font-[Space_Grotesk] text-sm font-medium text-[#8C846F]">Included</span>
      )}
    </div>
  );
}
      ...
      >
        ...
        {submitted ? (
          <div className="pt-4 text-center">
            <h2 className="font-['Fraunces'] text-2xl font-semibold text-[#0B4933]">Request received</h2>
          ...
          <>
            <p className="font-[Space_Grotesk] text-sm font-semibold tracking-[0.2em] text-[#8A6A1E]">YOUR EXPERIENCE IS READY</p>
            <h2 className="mt-1 font-['Fraunces'] text-2xl font-semibold text-[#0B4933]">
              {summary?.eventTypeLabel}
            </h2>
            {eventDate && (
              <p className="mt-1 font-[Space_Grotesk] text-sm text-[#8C846F]">For your event on {eventDate}</p>
            )}
            ...
            {summary && (
              <div className="mt-5 space-y-4 border-t border-[#EAE3D3] pt-4">
                ...
                {summary.experiences?.length > 0 && (
                  <div>
                    <p className="font-[Space_Grotesk] text-sm font-semibold tracking-[0.15em] text-[#0B4933]">EXPERIENCES</p>
                ...
                {summary.servingDish && (
                  <div>
                    <p className="font-[Space_Grotesk] text-sm font-semibold tracking-[0.15em] text-[#0B4933]">MAKE IT YOURS</p>
                ...
                {summary.playful?.length > 0 && (
                  <div>
                    <p className="font-[Space_Grotesk] text-sm font-semibold tracking-[0.15em] text-[#0B4933]">PLAYFUL ADD-ONS</p>
                ...
                {summary.guestGift && (
                  <div>
                    <p className="font-[Space_Grotesk] text-sm font-semibold tracking-[0.15em] text-[#0B4933]">GUEST GIFT</p>
                ...
                {summary.addons?.length > 0 && (
                  <div>
                    <p className="font-[Space_Grotesk] text-sm font-semibold tracking-[0.15em] text-[#0B4933]">ADD-ONS</p>
                ...
                {summary.serviceStyle && (
                  <div>
                    <p className="font-[Space_Grotesk] text-sm font-semibold tracking-[0.15em] text-[#0B4933]">SERVICE</p>
            ...
            <p className="mt-5 font-[Space_Grotesk] text-sm leading-5 text-[#8C846F]">
